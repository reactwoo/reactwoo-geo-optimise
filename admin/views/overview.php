...
<div class="wrap rwgc-wrap rwgo-wrap rwgo-wrap--overview">
	...
	<?php if ( 0 === $managed_tests_total ) : ?>
		<div class="rwgo-panel rwgo-panel--hero">
			<h2 class="rwgo-section__title"><?php esc_html_e( 'Welcome — run your first page test', 'reactwoo-geo-optimise' ); ?></h2>
			<p class="rwgo-section__lead"><?php esc_html_e( 'Choose a page, create a second version to compare, set the audience and goal, then publish.', 'reactwoo-geo-optimise' ); ?></p>
	...
	<?php else : ?>
		<div class="rwgo-panel rwgo-panel--hero">
			<h2 class="rwgo-section__title"><?php esc_html_e( 'Next steps', 'reactwoo-geo-optimise' ); ?></h2>
			<ol class="rwgo-steps">
	...
	<div class="rwgo-panel">
		<h2 class="rwgo-section__title"><?php esc_html_e( 'At a glance', 'reactwoo-geo-optimise' ); ?></h2>
		<p class="rwgo-section__lead"><?php
			printf(
